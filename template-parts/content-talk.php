		...
		<div class="entry-content">
			...
			<section>
				<div class="talk-info">
					...
					<h1 class="talk-title h3"><?php the_field( 'title' ); ?></h1>
					<?php } ?>
					...
					<h2 class="talk-speaker h1">
						...
						?>
						<span class="talk-event">at <?php the_field( 'event' ); ?></span></h2>
						<?php } ?>
					<?php } ?>
				...
				<div class="social-media-integration">
					...
					<div class="smi-widget share-button share-facebook"><iframe src="https://www.facebook.com/plugins/share_button.php?href=<?php echo urlencode(mb_convert_encoding(get_permalink(), 'UTF-8', 'ISO-8859-1')); ?>&layout=button&size=large&mobile_iframe=true&width=73&height=28&appId" width="73" height="28" title="Share on Facebook" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe></div>
				</div>
			</section>
			...
			<section>
				<div class="about-this-speaker">
					...
					<div class="bio">
						...
						<div class="bio-profession h2"><?php the_field( 'profession' ); ?></div>
						<?php } ?>
